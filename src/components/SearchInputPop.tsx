...
function SearchInputPop({ focus }: SearchInputProps) {
  ...
  return (
    <>
      ...
      <form
        ...
        className="w-full h-full  text-white  bg-opacity-75 rounded grid grid-cols-4 divide-x divide-slate-200 mt-1 mb-1"
      >
